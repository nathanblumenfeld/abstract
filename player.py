    ...
    def run(self): 
        ...
        if submitted: 
                try: 
                    ...
                    st.warning('no records found')
        st.write('')          
        st.info('Data from stats.ncaa.org. Last Updated: 4/11. Linear Weights for seasons 2013-2021 courtesy of Robert Frey. Note: Linear Weights for 2022 season are average of past five seasons.')
