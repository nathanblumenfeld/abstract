...
class TeamApp(HydraHeadApp):
    ...
    #             .highlight_max(axis=0, props='color:white; font-weight:bold; background-color:#147DF5;', subset=rate_slice).highlight_min(axis=0, props='color:white; font-weight:bold; background-color:#d45087;', subset=rate_slice))
        ...
        st.write('')          
        st.info('Data from stats.ncaa.org. Last Updated: 4/11. Percentiles relative to all D1 players with 20+ PA. Linear Weights for seasons 2013-2021 courtesy of Robert Frey. Note: Linear Weights for 2022 season are average of past five seasons.')
