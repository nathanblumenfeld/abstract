...
class LeaderboardsApp(HydraHeadApp):
    def run(self): 
        ...
        st.write('')          
        st.info('Data from stats.ncaa.org. Last Updated: 4/3. Linear Weights for seasons 2013-2021 courtesy of Robert Frey. Note: Linear Weights for 2022 season are average of past five seasons.')
